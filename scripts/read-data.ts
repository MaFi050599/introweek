...
const readData = async () => {
    ...
    console.log("people_roles_data", people_roles_data);
    console.log("people_themegroup_data", people_themegroup_data);
    ...
    const ss_sorted = shared_shifts
        ...
        .map(({ person, shifts }) => {
            const personName = person.replace("�", "ø");
            console.log(`Sorting schedule for: ${personName}`);
            return {
                person: personName,
